...
import 'package:simply_news/pages/favorites/widgets/animated_counted.dart';

void main() {
  group('AnimatedCounter', () {
    testWidgets(
      'renders with initial value of 0 and animates to given value',
      (WidgetTester tester) async {
        await tester.pumpWidget(
          const MaterialApp(
            home: Scaffold(
              body: AnimatedCounter(10),
            ),
          ),
        );
    ...
    testWidgets(
      'uses provided animation curve and duration',
      (WidgetTester tester) async {
        ...
        final TweenAnimationBuilder<num> tweenWidget =
            tester.widget<TweenAnimationBuilder<num>>(tweenFinder);
    ...
    testWidgets(
      'asserts that value is greater than or equal to 0',
      (WidgetTester tester) async {
