...
void main() {
  group('NewsArticleCard', () {
    ...
    testWidgets(
      'renders article title and author when provided',
    ...
    testWidgets(
      'renders favorite icon correctly based on isFavorite value',
      (WidgetTester tester) async {
        await tester.pumpWidget(
          MaterialApp(
            home: Scaffold(
    ...
    testWidgets(
      'calls onFavorite callback when favorite button is tapped',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'renders without an author if none is provided',
      (WidgetTester tester) async {
        ...
        // Verify that the title is displayed.
        expect(
          find.byKey(const Key('news_article_card_title')),
          findsOneWidget,
        );
    ...
    testWidgets(
      'uses Card with correct styling',
      (WidgetTester tester) async {
